...
/* ═══════════════════════════════════════════════════════════════════════════
   RedasP — server.js  v3.1  (domínio EDUSP: edusp-api.ip.tv)
...
const EDUSP         = 'https://edusp-api.ip.tv'; // DOMÍNIO CORRETO DA EDUSP
...
async function sedLogin(ra, senha) {
  ...
  // 2ª etapa: EDUSP token (USANDO DOMÍNIO CORRETO)
...
/* ═══════════════════════════════════════════════════════════════════════════
   SESSIONS E ROTAS (a partir daqui, mantenha o que você já tinha, com a
   correção do domínio EDUSP em todas as chamadas)
═══════════════════════════════════════════════════════════════════════════ */
